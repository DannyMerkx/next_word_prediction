...
model_loc = '/home/danny/Downloads/trained_models'
...
transformer_config_ = {'embed': {'n_embeddings': dict_size,
                                'embedding_dim': 400, 'sparse': False, 
                                'padding_idx':0
                                }, 
...
gru_config = {'embed':{'n_embeddings': dict_size, 'embedding_dim': 400, 
                      ...
                      'att': {'in_size': 500, 'hidden_size': 128, 'h': 1
                              },
                      'cuda': False
              }

gru_config_ = {'embed':{'n_embeddings': dict_size, 'embedding_dim': 400, 
                       'sparse': False, 'padding_idx': 0
                       }, 
                      'max_len': 41,
                      'rnn':{'in_size': 400, 'hidden_size': 500, 
...
transformer_ = nwp_transformer(transformer_config_)

gru = nwp_rnn_encoder(gru_config)
gru_ = nwp_rnn_encoder(gru_config_)
#gru_tf_att = nwp_rnn_tf_att(gru_config)

encoder_models = [transformer, transformer_, gru, gru_]
###############################################################################
data = pd.DataFrame()
