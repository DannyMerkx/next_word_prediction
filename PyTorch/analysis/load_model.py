...
model_loc = '/home/danny/Downloads/new_folder/'
...
# set words followed by a comma to nan as they were excluded in the original experiment. 
...
tf_8l_config = {'embed': {'n_embeddings': dict_size,
                                'embedding_dim': 400, 'sparse': False, 
                                'padding_idx':0
                                }, 
                      'tf':{'in_size': 400, 'fc_size': 1024,'n_layers': 8,
                            'h': 8, 'max_len': 41
                            },
                      'cuda': False
                      }
...
for model_loc in model_list:
    ...
    # with the nr of training samples of the model. N.B. the indices here are hard
    # coded for my specific folder structure and file naming convention. 
...
data.to_csv(path_or_buf = '/home/danny/Documents/databases/next_word_prediction/surprisal_data/surprisal3.csv')
