...
@author: danny
"""
from mini_batcher import char_batcher, token_batcher_rnn
...
class nwp_trainer():
    ...
    def token_batcher(self, sents, batch_size, max_len, shuffle):
        return token_batcher_gru(sents, batch_size, self.dict_loc, max_len, shuffle)
...
######################## evaluation functions #################################
    ...
    def save_params(self, loc):
        torch.save(self.encoder.state_dict(), os.path.join(loc, 'nwp_model' + '.' +str(self.epoch)))
